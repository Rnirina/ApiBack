...
public class Categorie extends HttpServlet {
    ...
    private ServiceCategorie services;

    public void init(ServletConfig config) throws ServletException  {
        super.init(config);
        try {
            PoolConnection pool = new PoolConnection();
            services = new ServiceCategorie(pool);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getParameter("idCategorie") != null) {
                json = new Gson().toJson(this.services.getUn(Integer.parseInt(request.getParameter("idCategorie"))));
            } else {
